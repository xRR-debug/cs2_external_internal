...
public:
    ...
    int m_tab = 0;
    vector < const char* > tabs = { "Legitbot" }, tabs_icons = { "B" };

    int m_legitbot_subtab = 0;
    vector < const char* > legitbot_subtabs = { "Aimbot", "Triggerbot", "Visuals", "Misc", "Config" };
    ...
    int accent_color[4] = { 76, 222, 252, 255 };
